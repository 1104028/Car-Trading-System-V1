...
@section('content')
    <h2 style="text-align:center;">Update Best Selling Car</h2>
    ...
    @endif
    <form method="POST" action="{{ route('bestseller.update',$id) }}">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        <style>
            .register-box {
            ...
            <div class="register-box-body">
                <div class="form-group has-feedback">
                    ...
                    <select class="form-control" data-val="true"
                            ...
                            id="CompanyID" name="CompanyID" onchange="getbrandlist(this.value)">
                ...
                <div class="form-group has-feedback">
                    ...
                    <select class="form-control" data-val="true"
                            ...
                            data-val-required="The Brand Name field is required."
                            id="BrandID" name="BrandID" onchange="getmodellist(this.value)">
